...
public class CreateWebAppDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        subscriptionComboBox.addPostSelectionChangedListener(event -> {
        ...
        instanceDetailPanel.getRegionComboBox().addPostSelectionChangedListener(event -> {
        ...
        instanceDetailPanel.getRuntimeComboBox().addPostSelectionChangedListener(event -> {
