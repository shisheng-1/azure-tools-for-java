...
public class AzureInitializer {
    ...
    private static void initializeTelemetry() {
        final String oldVersion = AzureStoreManager.getInstance().getAppStore().getProperty(AzureConfigInitializer.TELEMETRY, AzureConfigInitializer.TELEMETRY_PLUGIN_VERSION);
